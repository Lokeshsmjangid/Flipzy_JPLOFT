          ...
          return Scaffold(
            ...
            bottomNavigationBar: BorderedContainer(
                    ...
                    child: AppButton(
                        ...
                        .marginSymmetric(horizontal: 4)).marginSymmetric(horizontal: 12),
            body: logic.isDataLoading // ? Center(child: CircularProgressIndicator(color: AppColors.secondaryColor))
                ? Shimmer.fromColors(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                        Expanded(
                                            child: addText500("Total Earnings",
                                                maxLines: 2,
                                    ...
                                    addText700(
                                        "₦${logic.response.data!.summary!.totalEarnings}",
                                        maxLines: 2,
                                        color: AppColors.whiteColor,
                                        fontSize: 40,
                                        fontFamily: ''),
                                    addText400(
                                        "Payouts are processed weekly/monthly.",
                                        maxLines: 2,
                                        color: AppColors.whiteColor,
                                        fontSize: 15),
                                  ],
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Align(
                                              ...
                                              child: addText700(
                                                  "₦${logic.response.data!.summary!.availableBalance}",
                                                  maxLines: 2,
                                                  color: AppColors.blackColor,
                                                  fontSize: 18,
                                                  fontFamily: '')),
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Align(
                                              alignment: Alignment.bottomLeft,
                                              child: addText700(
                                                  "₦${logic.response.data!.summary?.withdrawnBalance}",
                                                  maxLines: 2,
                                                  color: AppColors.blackColor,
                                                  fontSize: 18,
                                                  fontFamily: '')),
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          addText500("Transaction History",
                                              maxLines: 2,
                                              color: AppColors.blackColor,
                                              fontSize: 15),
                                          IconButton(
                                    ...
                                    logic.response.data!.transactions!
                                            .isNotEmpty
                                        ? ListView.builder(
                                            shrinkWrap: true,
                                            padding: EdgeInsets.zero,
                                            itemCount: logic.response.data!
                                                .transactions!.length,
                                            physics:
                                                    ...
                                                    child: Row(
                                                      children: [
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            addText700(
                                                                "${AuthData().userModel?.firstname?.capitalize} ${AuthData().userModel?.lastname?.capitalize}"),
                                                            SizedBox(height: 2),
                                                            addText500(
                                                                "Transaction: #${logic.response.data!.transactions![item].trackingId}",
                                                                color: AppColors
                                                                    .txtGreyColor),
                                                        ...
                                                        //NotificationsNumber
                                                        addText500(
                                                            "\$${logic.response.data!.transactions![item].price}",
