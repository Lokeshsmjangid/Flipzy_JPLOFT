...
class GetReadyDialogWidget extends StatelessWidget {
  void Function()? onTap;

  GetReadyDialogWidget({this.onTap});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Get Started!',fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
                    addText500('"Your profile is all set up! You can now browse listings, save your favorites, and start reaching out to sellers for your desired items."',
                        fontFamily: 'Manrope',fontSize: 13,textAlign: TextAlign.center,color: AppColors.blackColor).marginSymmetric(horizontal: 4),
  ...
  continueButton({void Function()? onTap}){
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: addText700('Homepage',fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor)),
