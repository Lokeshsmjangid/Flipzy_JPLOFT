...
class PurchaseThanksDialogWidget extends StatelessWidget {

  PurchaseThanksDialogWidget();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Thank You for Your Purchase!',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
