...
class DeclineOrderSuccessDialog {
  static void show(BuildContext context) {
    showDialog(
      context: context,
       barrierColor: Color(0xff56716a).withOpacity(0.75),
      barrierDismissible: false,
      builder: (_) => DeclineOrderSuccessDialogWidget(),
    );
  }
}

class DeclineOrderSuccessDialogWidget extends StatelessWidget {

  DeclineOrderSuccessDialogWidget();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Thanks, We will notify Customer about this.',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
