...
class FeedbackThanksDialog {
  static void show(BuildContext context) {
    showDialog(
      context: context,
      barrierColor: Color(0xff56716a).withOpacity(0.75),
      barrierDismissible: false,
      builder: (_) => FeedbackThanksDialogWidget(),
    );
  }
}

class FeedbackThanksDialogWidget extends StatelessWidget {

  FeedbackThanksDialogWidget();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('"Thank You for Your Feedback!"',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
