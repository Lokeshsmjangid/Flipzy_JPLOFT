...
class SellerProductReadyDialog {
...
class SellerProductReadyDialogWidget extends StatelessWidget {
  void Function()? onTap;

  SellerProductReadyDialogWidget({this.onTap});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Your Seller Profile is Ready!',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
  ...
  continueButton({void Function()? onTap}){
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(child: addText700('Upload Product',fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor)),
