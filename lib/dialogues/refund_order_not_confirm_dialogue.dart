...
class RefundOrderNotConfirmationDialog {
  static void show(BuildContext context) {
    showDialog(
      context: context,
       barrierColor: Color(0xff56716a).withOpacity(0.75),
      barrierDismissible: false,
      builder: (_) => RefundOrderNotConfirmationDialogWidget(),
    );
  }
}

class RefundOrderNotConfirmationDialogWidget extends StatelessWidget {

  RefundOrderNotConfirmationDialogWidget();
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Thanks, Please update the status once received',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
