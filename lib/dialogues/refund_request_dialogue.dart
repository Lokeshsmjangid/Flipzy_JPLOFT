...
class RefundRequestDialog {
  static void show(BuildContext context,{void Function()? onTap,TextEditingController?msgCtrl }) {
    showDialog(
      ...
      builder: (_) => RefundRequestDialogWidget(onTap: onTap,msgCtrl: msgCtrl,),
    );
  }
}

class RefundRequestDialogWidget extends StatelessWidget {
  void Function()? onTap;
  TextEditingController? msgCtrl;

  RefundRequestDialogWidget({this.onTap,this.msgCtrl});
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: continueButton(buttonText: 'Request for Refund',onTap: onTap,color: AppColors.primaryColor),),
