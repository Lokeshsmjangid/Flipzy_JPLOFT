...
class DeclineReturnRequestDialog {
...
class DeclineReturnRequestDialogWidget extends StatelessWidget {
  void Function()? onTap;
  TextEditingController? msgCtrl;

  DeclineReturnRequestDialogWidget({this.onTap,this.msgCtrl});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Why you want to decline this return request? Please Specify.',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 20,color: AppColors.blackColor).marginAll(15),
