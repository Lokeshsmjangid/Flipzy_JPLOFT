...
class LogoutAccountDialog {
  static void show(BuildContext context,{void Function()? onTap1,void Function()? onTap2}) {
    showDialog(
      ...
      builder: (_) => LogoutAccountDialogWidget(onTap1: onTap1,onTap2: onTap2),
    );
  }
}

class LogoutAccountDialogWidget extends StatelessWidget {
  void Function()? onTap1;
  void Function()? onTap2;

  LogoutAccountDialogWidget({this.onTap1,this.onTap2});
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    addText700('Are you sure you want to logout your account?',textAlign: TextAlign.center,fontFamily: 'Manrope',fontSize: 22,color: AppColors.blackColor).marginSymmetric(horizontal: 20),
                    ...
                    Row(
                      ...
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        continueButton(buttonText: 'Yes',onTap: onTap1,color: AppColors.primaryColor),
                        // addWidth(8),
                        continueButton(buttonText: 'No',onTap: onTap2,color: Color(0XFFEEF2ED),buttonTextColor: AppColors.blackColor)
